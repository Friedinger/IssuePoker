...
class CacheControlFilterTest {
    ...
    private static final String ISSUES_ENDPOINT_URL = "/issues";
    ...
    @Test
    void testForCacheControlHeadersForIssuesEndpoint() {
        final ResponseEntity<String> response = testRestTemplate.exchange(ISSUES_ENDPOINT_URL, HttpMethod.GET, null, String.class);
